...
3. The Audience ID used in the [API calls](https://learn.microsoft.com/en-au/partner-center/marketplace-offers/partner-center-portal/pc-saas-fulfillment-subscription-api) should be set to `20e940b3-4c77-4b0b-9a53-9e16a1b010a7`.
