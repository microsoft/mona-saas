...
namespace Mona.SaaS.Web.Authorization
{
    ...
    {
        // TODO: Should we make this app role-based? Trying to keep things as simple as possible
        // but this change may make sense for the next version...
        ...
        {
            if ((context.User.HasClaim(tenantIdClaimType, requirement.AdminAadTenantId)) &&
               ((requirement.MustBeAdminUser == false) || context.User.HasClaim(objectIdClaimType, requirement.AdminAadUserId)))
            {
